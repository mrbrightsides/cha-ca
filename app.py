...
with st.sidebar:
    ...
    st.sidebar.markdown("""
    **Cha-Ca (Chain Baca)** lahir dari semangat untuk menjembatani dunia teknologi, literasi, dan spiritualitas.
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/cha-ca)
...
embed_iframe(iframe_url, hide_top_px=20, hide_bottom_px = -125, height=800)
